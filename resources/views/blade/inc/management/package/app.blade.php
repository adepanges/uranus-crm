...
@parent
        ...
        <script src="{{ base_url('js/module/management/package.js') }}" type="text/javascript"></script>
@endsection
...
@section('content')
            <div class="row bg-title">
                ...
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Management Package</h4> </div>
                <!-- /.page title -->
            </div>
            ...
            <div class="modal fade" id="packageModal" role="dialog" aria-labelledby="exampleModalLabel1"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="packageForm" data-toggle="validator" data-delay="100">
                                ...
                                <div class="form-group">
                                    <label for="recipient-name" class="control-label">Tipe Harga</label>
                                    <select class="form-control" name="price_type" data-error="Hmm, tipe harga harap diisi" required>
                                ...
                                <div class="form-group" id="fieldPrice">
                                    ...
                                    <div class="input-group m-b-30">
                                        ...
                                        <input type="number" class="form-control" name="price" data-error="Hmm, harga produt harap diisi">
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="btnSavePackage" type="button" class="btn btn-primary">Simpan</button>
                        </div>
                    </div>
                </div>
            </div>
