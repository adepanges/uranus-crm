...
class Orders_model extends Penjualan_Model {
    protected
        ...
        $fillable_field = ['franchise_id','payment_method_id','logistic_id','order_status_id','logistics_status_id','order_status','logistics_status','call_method_id','customer_info','customer_address','total_price','customer_id','customer_address_id','note'],
